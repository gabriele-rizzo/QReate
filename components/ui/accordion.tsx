...
function AccordionItem({ className, ...props }: AccordionPrimitive.Item.Props) {
    return (
        <AccordionPrimitive.Item
            ...
            className={cn("border-b data-open:bg-muted/50", className)}
            {...props}
        />
    );
}
        ...
        <AccordionPrimitive.Header className="flex">
            ...
            >
                ...
                <CaretDownIcon
                    ...
                    className="pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:rotate-180 transition-transform"
                />
            </AccordionPrimitive.Trigger>
...
function AccordionContent({ className, children, ...props }: AccordionPrimitive.Panel.Props) {
    return (
        <AccordionPrimitive.Panel
            ...
            className="overflow-hidden pt-1 px-4 text-sm data-open:animate-accordion-down data-closed:animate-accordion-up"
            {...props}
        >
            <div
                className={cn(
